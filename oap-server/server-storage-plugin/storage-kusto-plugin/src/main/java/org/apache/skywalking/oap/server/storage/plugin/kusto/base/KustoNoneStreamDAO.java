...
public class KustoNoneStreamDAO implements INoneStreamDAO {
    ...
    public void insert(final Model model, final NoneStream noneStream) throws IOException {
        // TODO: Insert configuration/reference data that is not time-series.
        // Use kustoClient.mgmt() with .ingest inline or streaming ingest.
        throw new UnsupportedOperationException("TODO: Implement Kusto NoneStream insert");
    }
}
