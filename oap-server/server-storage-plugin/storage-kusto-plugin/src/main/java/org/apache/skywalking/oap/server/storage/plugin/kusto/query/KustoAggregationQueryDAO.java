...
public class KustoAggregationQueryDAO implements IAggregationQueryDAO {
    private final KustoClient kustoClient;

    public KustoAggregationQueryDAO(final KustoClient kustoClient) {
    ...
    public List<SelectedRecord> sortMetrics(TopNCondition condition,
        ...
        throw new UnsupportedOperationException("TODO: Implement Kusto sortMetrics");
    }
}
