...
public class KustoAlarmQueryDAO implements IAlarmQueryDAO {
    private final KustoClient kustoClient;

    public KustoAlarmQueryDAO(final KustoClient kustoClient) {
    ...
    public Alarms getAlarm(final Integer scopeId,
        ...
        throw new UnsupportedOperationException("TODO: Implement Kusto getAlarm");
    }
}
