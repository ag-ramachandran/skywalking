...
public class KustoAsyncProfilerTaskLogQueryDAO implements IAsyncProfilerTaskLogQueryDAO {
    private final KustoClient kustoClient;

    public KustoAsyncProfilerTaskLogQueryDAO(final KustoClient kustoClient) {
        this.kustoClient = kustoClient;
    }

    @Override
    public List<AsyncProfilerTaskLog> getTaskLogList() throws IOException {
        throw new UnsupportedOperationException("TODO: Implement Kusto async profiler getTaskLogList");
    }
}
