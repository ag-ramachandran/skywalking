...
public class KustoAsyncProfilerTaskQueryDAO implements IAsyncProfilerTaskQueryDAO {
    private final KustoClient kustoClient;

    public KustoAsyncProfilerTaskQueryDAO(final KustoClient kustoClient) {
    ...
    public List<AsyncProfilerTask> getTaskList(final String serviceId,
        ...
        throw new UnsupportedOperationException("TODO: Implement Kusto async profiler getTaskList");
    }

    @Override
    public AsyncProfilerTask getById(final String id) throws IOException {
        throw new UnsupportedOperationException("TODO: Implement Kusto async profiler getById");
    }
}
