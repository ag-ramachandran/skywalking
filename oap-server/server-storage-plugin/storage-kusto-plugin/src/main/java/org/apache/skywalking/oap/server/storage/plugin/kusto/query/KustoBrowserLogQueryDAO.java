...
public class KustoBrowserLogQueryDAO implements IBrowserLogQueryDAO {
    private final KustoClient kustoClient;

    public KustoBrowserLogQueryDAO(final KustoClient kustoClient) {
    ...
    public BrowserErrorLogs queryBrowserErrorLogs(String serviceId,
        ...
        throw new UnsupportedOperationException("TODO: Implement Kusto queryBrowserErrorLogs");
    }
}
