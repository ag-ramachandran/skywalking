...
public class KustoContinuousProfilingPolicyDAO implements IContinuousProfilingPolicyDAO {
    private final KustoClient kustoClient;

    public KustoContinuousProfilingPolicyDAO(final KustoClient kustoClient) {
        this.kustoClient = kustoClient;
    }

    @Override
    public void savePolicy(ContinuousProfilingPolicy policy) throws IOException {
        throw new UnsupportedOperationException("TODO: Implement Kusto continuous profiling savePolicy");
    }

    @Override
    public List<ContinuousProfilingPolicy> queryPolicies(List<String> serviceIdList) throws IOException {
        throw new UnsupportedOperationException("TODO: Implement Kusto continuous profiling queryPolicies");
    }
}
