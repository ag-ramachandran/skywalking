...
public class KustoEBPFProfilingScheduleDAO implements IEBPFProfilingScheduleDAO {
    private final KustoClient kustoClient;

    public KustoEBPFProfilingScheduleDAO(final KustoClient kustoClient) {
        this.kustoClient = kustoClient;
    }

    @Override
    public List<EBPFProfilingSchedule> querySchedules(final String taskId) throws IOException {
        throw new UnsupportedOperationException("TODO: Implement Kusto EBPF querySchedules");
    }
}
