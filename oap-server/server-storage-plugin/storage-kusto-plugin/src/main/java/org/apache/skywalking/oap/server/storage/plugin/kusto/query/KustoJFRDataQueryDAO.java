...
public class KustoJFRDataQueryDAO implements IJFRDataQueryDAO {
    private final KustoClient kustoClient;

    public KustoJFRDataQueryDAO(final KustoClient kustoClient) {
        this.kustoClient = kustoClient;
    }

    @Override
    public List<JFRProfilingDataRecord> getByTaskIdAndInstancesAndEvent(final String taskId,
                                                                       List<String> instanceIds,
                                                                       final String eventType) throws IOException {
        throw new UnsupportedOperationException(
            "TODO: Implement Kusto JFR getByTaskIdAndInstancesAndEvent");
    }
}
