...
public class KustoPprofDataQueryDAO implements IPprofDataQueryDAO {
    private final KustoClient kustoClient;

    public KustoPprofDataQueryDAO(final KustoClient kustoClient) {
        this.kustoClient = kustoClient;
    }

    @Override
    public List<PprofProfilingDataRecord> getByTaskIdAndInstances(final String taskId,
                                                                  List<String> instanceIds) throws IOException {
        throw new UnsupportedOperationException("TODO: Implement Kusto pprof getByTaskIdAndInstances");
    }
}
