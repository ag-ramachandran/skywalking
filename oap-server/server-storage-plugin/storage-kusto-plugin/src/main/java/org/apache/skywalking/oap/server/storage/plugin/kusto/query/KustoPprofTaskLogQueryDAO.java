...
public class KustoPprofTaskLogQueryDAO implements IPprofTaskLogQueryDAO {
    private final KustoClient kustoClient;

    public KustoPprofTaskLogQueryDAO(final KustoClient kustoClient) {
        this.kustoClient = kustoClient;
    }

    @Override
    public List<PprofTaskLog> getTaskLogList() throws IOException {
        throw new UnsupportedOperationException("TODO: Implement Kusto pprof getTaskLogList");
    }
}
