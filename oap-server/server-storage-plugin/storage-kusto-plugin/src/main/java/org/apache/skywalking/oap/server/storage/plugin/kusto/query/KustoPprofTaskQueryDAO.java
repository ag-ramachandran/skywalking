...
public class KustoPprofTaskQueryDAO implements IPprofTaskQueryDAO {
    private final KustoClient kustoClient;

    public KustoPprofTaskQueryDAO(final KustoClient kustoClient) {
    ...
    public List<PprofTask> getTaskList(final String serviceId,
        ...
        throw new UnsupportedOperationException("TODO: Implement Kusto pprof getTaskList");
    }

    @Override
    public PprofTask getById(final String id) throws IOException {
        throw new UnsupportedOperationException("TODO: Implement Kusto pprof getById");
    }
}
