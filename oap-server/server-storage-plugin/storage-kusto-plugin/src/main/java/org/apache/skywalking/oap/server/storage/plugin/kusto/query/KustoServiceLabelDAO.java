...
public class KustoServiceLabelDAO implements IServiceLabelDAO {
    private final KustoClient kustoClient;

    public KustoServiceLabelDAO(final KustoClient kustoClient) {
        this.kustoClient = kustoClient;
    }

    @Override
    public List<String> queryAllLabels(String serviceId) throws IOException {
        throw new UnsupportedOperationException("TODO: Implement Kusto queryAllLabels");
    }
}
