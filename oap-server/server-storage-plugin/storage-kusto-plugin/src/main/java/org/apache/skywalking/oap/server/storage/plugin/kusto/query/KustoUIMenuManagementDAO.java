...
public class KustoUIMenuManagementDAO implements UIMenuManagementDAO {
    private final KustoClient kustoClient;

    public KustoUIMenuManagementDAO(final KustoClient kustoClient) {
        this.kustoClient = kustoClient;
    }

    @Override
    public UIMenu getMenu(String id) throws IOException {
        throw new UnsupportedOperationException("TODO: Implement Kusto UI menu getMenu");
    }

    @Override
    public void saveMenu(UIMenu menu) throws IOException {
        throw new UnsupportedOperationException("TODO: Implement Kusto UI menu saveMenu");
    }
}
